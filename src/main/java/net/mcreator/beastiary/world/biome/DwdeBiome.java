...
package net.mcreator.beastiary.world.biome;
...
import net.mcreator.beastiary.BeastiaryModElements;

@BeastiaryModElements.ModElement.Tag
public class DwdeBiome extends BeastiaryModElements.ModElement {
	public static Biome biome;
	public DwdeBiome(BeastiaryModElements instance) {
		super(instance, 1);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(Blocks.BIRCH_PLANKS.getDefaultState(),
				...
				event.getRegistry().register(biome.setRegistryName("beastiary:dwde"));
			}
		}
	}
	@Override
